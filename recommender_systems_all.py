...
if __name__ == "__main__":
    ...
    print
    print "already like:", ["NoSQL", "Python", "MongoDB", "regression", "Postgres"]
    print most_popular_new_interests(["NoSQL", "Python", "MongoDB", "regression", "Postgres"])
    print
    ...
    print "most similar to 2"
    print most_similar_users_to(2)

    print "Suggestions for 2"

...
from statistics_all import correlation, standard_deviation, mean
from probability_all import inverse_normal_cdf
from gradient_descent_all import maximize_batch
...
def compare_two_distributions():
    ...
    normal = [57 * inverse_normal_cdf(random.random())
              for _ in range(200)]
    data1 = [3, 10, 45, 68, 15, 23, 54, 95, 45, 14, 77, 66, 26, 35, 48, 25, 30, 49, 78, 62, 59, 54, 11, 2, 87]

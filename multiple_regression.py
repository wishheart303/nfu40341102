...
from statistics_all import median, standard_deviation
from probability_all import normal_cdf
...
if __name__ == "__main__":
    ...
    print "---test begin 20170518---"

    x1 = [1, 42, 8, 0]
    x2 = [1, 66, 7, 1]
    x3 = [1, 10, 8, 1]

    print "x1: ", predict(x1, beta)
    print "x2: ", predict(x2, beta)
    print "x3: ", predict(x3, beta)
    print "---test end 20170518---\n"
